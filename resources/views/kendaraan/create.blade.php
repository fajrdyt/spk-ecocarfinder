...
@section('title', 'Tambah Kendaraan - EcoCarFinder')

@section('content')
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="fas fa-plus-circle me-2"></i>Tambah Kendaraan</h2>
                    ...
                    <form action="{{ route('kendaraan.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('cylinders') is-invalid @enderror" 
                                       name="cylinders" value="{{ old('cylinders') }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('fuel_consumption_comb') is-invalid @enderror" 
                                       name="fuel_consumption_comb" value="{{ old('fuel_consumption_comb') }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.1" class="form-control @error('fuel_consumption_mpg') is-invalid @enderror" 
                                       name="fuel_consumption_mpg" value="{{ old('fuel_consumption_mpg') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('co2_emissions') is-invalid @enderror" 
                                   name="co2_emissions" value="{{ old('co2_emissions') }}" 
